    ...
    <>
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="inline-block px-3 py-1 bg-blue-100 text-blue-700 text-sm rounded-full font-medium">
                          우편번호: {address.zipNo}
                        </div>
                      </div>
      ...
      <div className="flex justify-center mb-4">
        <div className="relative flex w-full flex-wrap items-stretch">
          <div className="w-full p-3 text-left font-bold">우편번호 (선택)</div>
          <input
            className="w-full p-3 rounded border border-solid border-neutral-500 shadow-md bg-gray-100"
            name="postalCode"
            type="text"
      ...
      <div className="flex justify-center mb-4">
        <div className="relative flex w-full flex-wrap items-stretch">
          <div className="w-full p-3 text-left font-bold">주소검색</div>
      ...
      <div className="flex justify-center mb-4">
        <div className="relative flex w-full flex-wrap items-stretch">
          <div className="w-full p-3 text-left font-bold">상세주소 (선택)</div>
          <input

...
import lombok.*;
import org.zerock.mallapi.util.DateTimeUtil;
...
public class Member {
    ...
    private String nickname;    @Column(name = "phone")
    private String phone;    @Column(name = "postal_code")
    ...
    @Column(name = "social")
    @Builder.Default
    private Boolean social = false;    @Column(name = "modified_date", nullable = true, columnDefinition = "DATETIME")
    ...
    @JsonFormat(pattern = DateTimeUtil.DATE_TIME_PATTERN, timezone = "Asia/Seoul")
    private LocalDateTime joinedDate;// 변경 메서드들
    ...
    public void changeSocial(boolean social){
        ...
        this.phone = phone;
        this.modifiedDate = DateTimeUtil.getModifiedTime();
    }    public void changeAddress(String postalCode, String detailAddress) {

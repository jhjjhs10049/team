package org.zerock.mallapi.domain.admin.service;
...
import org.zerock.mallapi.domain.admin.entity.Banned;
import org.zerock.mallapi.domain.admin.repository.BannedRepository;
...
public class AdminServiceImpl implements AdminService {
    ...
    @Override
    public List<BannedDTO> getAdminActions(Long adminId) {
        log.info("관리자 조치 내역 조회 요청: adminId = {}", adminId);
        
        List<Banned> actions = bannedRepository.findBansByAdmin(adminId);
